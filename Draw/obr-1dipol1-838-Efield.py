...
inputName = "1dipol1"
fileName1 = inputName + "-Efield3"
fileName2 = inputName + "-Efield6"
plotName = "1dipol1-838-Efield"
...
plt.xlabel (r'$x$')
plt.ylabel (r'$y$')
plt.title (r'$f = 0.838$, $r_{mid}=5$, $R=0.45$, $\epsilon = (3.5 \pm 0.05\mathrm{i})^2$')


plt.subplot(1,2,2)
ColorE = Complex2RGB(E2, 100., 30.)
